...
from src.utils import read_json, write_json, write_csv
import pandas as pd
import glob
...
def calc_all_jaccard_distances(k):
    ...
    for region in region_file_dict:
        ...
        fname = f'./work/jaccard/jaccard.{region}.{k}.json'
        write_json(fname, {
            'region': region,
